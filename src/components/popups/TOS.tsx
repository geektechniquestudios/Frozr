...
export const TOS: React.FC<Props> = ({}) => {
  return (
    <div className="scrollbar h-96 overflow-auto rounded-md border-2 border-gray-500">
      <h1 className="text-3xl">Terms and Conditions</h1>
      <p className="text-xs">Last updated: November 14, 2022</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Frozr.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Frozr, accessible from{" "}
            <a
              href="https://frozr.io"
      ...
      <ul>
        <li>By email: geektechniquestudios@gmail.com</li>
      </ul>
    </div>
  )
}
